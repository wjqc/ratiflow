...
pub const REGISTRY: &[Entry] = &[
    ...
    Entry { method: "agent.trace", kind: Kind::Read, receipt: ReceiptMode::None, domain_key: "" },
    ...
    Entry { method: "skill.importDirectory", kind: Kind::Mutation, receipt: ReceiptMode::None, domain_key: "" },
    ...
    Entry { method: "skill.body", kind: Kind::Read, receipt: ReceiptMode::None, domain_key: "" },
    ...
    Entry { method: "workitem.updateRunDefaults", kind: Kind::Mutation, receipt: ReceiptMode::None, domain_key: "" },
    ...
    Entry { method: "workitem.get", kind: Kind::Read, receipt: ReceiptMode::None, domain_key: "" },
